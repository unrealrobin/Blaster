...
void UBlasterAnimInstance::NativeInitializeAnimation()
{
	...
	//Using Get Pawn Owner which will return a pawn, then we cast to an an ABlasterCharacter Type
...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaTime)
{
	...
	Velocity.Z = 0.f; //We dont need to worry about the Z portion of velocity
	Speed = Velocity.Size();// Gets me the Magnitude of this vector
